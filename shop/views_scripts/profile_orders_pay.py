...
def create_partial_checkout_session(request):
    if request.method == 'POST':
        ...
        try:
            ...
            metadata = {"Id": order_id, "email": email, "paid_price": full_price, "full_name": request.user.first_name + " " + request.user.last_name, "shippingPrice": shipping, "shippingAddress": shippingAddress, 'billingAddress': billingAddress, 'lang_code': language_code}
