...
function createProductCard(isCarousel, item, itemCounter, allItems, filteredItems, favouriteItems, pre_order_img_src, vocabulary, translations_categories, currency, change_fav_state_url, show_quantities, add_to_cart_url, cookie, checkout_url, user_auth, single_product_url){
...
let productGroups = {
 ...
 'Rosalie': ['63338', '61272', '62242', '63542'],

 'Vishap': ['32348', '12307', '23073'],

 'Royal': ['61198', '63271', '62145'],
 ...
 'Medium': ['KS013R70', '22074', 'KS013RG70', 'KS013R40', 'KS013RG40', 'KS013RG55', 'KS013G70', 'KS013R90', 'KS013G90', 'KS013G40', 'KS013G55', 'KS013RG90', 'KS013R55'],

 'Mati': ['41206', '32387', '23093', '23092', '32389', '23094', '12339', '32388', '12341', '12342'],

 'Cat': ['11362'],

 'Smooth': ['61186', '63265', '63262', '63263', '63264', '62130', '62133'],

 'Camille': ['63339', '61273', '62243'],

 'Drop': ['21018', 'S24019'],

 'earring': ['22071', '62060', '22700', '22148', '22702', '62042', '22285', '21002', '22110', '22000', '62057', '22086', '22973', '62066', '62075', '22698', '22975', '22394', '22722', '22654', '22715', '62062', '22186', '22697', '22687', '22254', '62067', '22312', '22707', '22315', '22142', '22695', '22139', '22097', '62080', '22194', '22442', '62078', '22126', '21001', '21008', '22446', '22288', '22146', '22113', '22343', '22012', '22077', '22341', '22970', '22319', '22646', '21009', '22201', '22708', '22630', '62124', '21004', '22132', '21013', '22971', '22204', '22974', '22688', '62079'],

 'Augusta': ['63274', '62148', '61200'],

 'Glee': ['62272', '63358', '61300'],

 'Nice': ['61068'],

 'Charlotte': ['23088', '12280'],
 ...
 'Pearl': ['22847', '32298', 'S24016', 'S24015', '22921', '22922', '32297', 'S24014', 'S24013', '41156', '22980', '12210', '12066', '12050'],

 'Nymph': ['32375', '12331', '23042'],

 'Bohemia': ['12393', '12392', '23118'],

 'Juventa': ['63273', '62147'],

 'Florita': ['11110'],

 'Earring': ['62258', '23173', '62259', '62173', '23170', '23169', '23171', '22740', '62257', '23168', '23172', '62256', '23166', '62255', '23174'],

 'Clavis': ['32241', '11989', '22801'],

 'Row': ['59100'],

 'Legend': ['12113', '63260', '22890'],

 'Little': ['32233', '11957', '32234', '11956'],
 ...
 'Splendor': ['63529', '63296', '62164', '61210'],

 'Joy': ['22786', '32239', '11972'],

 'Outspoken': ['12391'],

 'Velvet': ['61292', '63346', '62260'],

 'Close': ['32099'],

 'Bro': ['12233', '22996'],

 'Luster': ['41225', '23192', '12466'],

 'Fun': ['22331'],

 'Felicity': ['61270', '62239'],

 'Eternal': ['11397', '32319', '12256'],

 'Artemis': ['32384', '62152'],

 'Corazina': ['22792', '11982'],
 ...
 'Lofty': ['23200', '12476', '32430'],

 'Reach': ['22389', '11523'],

 'Ginkgo': ['63540', '61267', '63336', '61268', '62237'],

 'Life': ['11671', '22594', '32293'],

 'Anima': ['41200', '23086', '32372', '12328'],

 'Emotions': ['12326'],

 'Luxury': ['57004'],

 'Leaf': ['58013', '22686', '11792'],
 ...
 'FS': ['32291', '12185', '12187', '22931', '32290', '12186'],

 'Lion': ['41203', '32379', '23090', '12338'],

 'Joice': ['12023', '22821'],

 'Chain': ['KS014G40', 'KS002', 'KS003', 'KS014R40', '57143', 'KS014RG40'],

 'Initial': ['11850', '11844', '11854', '11846', '11837', '11852', '11830', '11848', '11833', '11831', '11847', '11840', '11841', '11845', '11855', '11832', '11836', '11851', '11853', '11838', '11839', '11835', '11843', '11834', '11842', '11849'],
 ...
 'Top': ['32226', '23011', '12251'],

 'Junction Cross': ['12475'],

 'Couple': ['32160', '11613'],

 'Poly': ['12335'],

 'Sunshine': ['63268', '61188', '62132', '63525'],

 'Spotlight': ['63531', '61225', '62180', '63320'],

 'Neptune': ['12302', '32346'],

 'BlueEye': ['41204'],

 'Anthosai': ['23063', '12284'],

 'Own': ['22918', '32288', '12169'],

 'Butterfly': ['S24017', '39102', 'S24011'],

 'Statement': ['12293'],

 'Sound': ['12243', '22965'],

 'Brilliance': ['63252', '63215', '63222', '63253', '61179', '62117', '61125', '63218', '61180', '62115', '62116', '61124', '61154'],

 'Horizon': ['41000', '41004'],

 'Moon': ['11945'],

 'Love': ['11703', '32224', '39104'],

 'Eternita': ['63290'],

 'Simple': ['63216', '11329', '11471', '11640'],

 'Doggy': ['22699', '11808'],

 'Kindness': ['12417', '32354', '23039'],

 'Better': ['62107'],

 'Halfmoon': ['23177', '12453'],

 'Believe': ['11328', '61177'],

 'Meriva': ['11073'],

 'Fleur': ['32003', '11030', '22073', '11171'],

 'Flourish': ['22913', '12153'],

 'Double': ['12007', '22156', '22155', '61178', '22815'],
 ...
 'Turtle': ['41201', '23087', '32373', '12330', '12136'],

 'Lauma': ['63280'],

 'Compass': ['61193'],

 'Classic': ['22105', '61185', '63520', 'V61185', '63259'],

 'Wake': ['12267', '23024'],

 'Exquisite': ['41207'],

 'back': ['K0003G', 'K0002R', 'K0001R', 'K0002G', 'K0003R', 'K0001G'],

 'Helios': ['12278', '32333'],

 'Character': ['41198'],

 'Tennis': ['32034', '22758', '11910'],

 'Hold': ['32315'],

 'Best': ['63528', '62136', 'V63528', '61191', '62135', '61190'],

 'Passion': ['23026', '12269', '12270'],

 'Fujin': ['32336'],

 'Jolie': ['63225'],

 'Princess': ['32248', '12079', '41065', '12032', '41064', '22834'],

 'Quartet': ['63301', '61215'],

 'Shahapet': ['41186'],

 'Butterflower': ['23097', '12340'],

 'Moxie': ['32371'],

 'Origin': ['32313', '22976', '12207'],

 'Apricus': ['61290'],

 'Coleus Green': ['63353'],

 'More': ['11330', '11148', '22164', '22295'],

 'Blossom': ['32404', '32403', '32361', '32405', '32357', '32358', '32376', '32360', '32377', '32359'],
 ...
 'Ameretat': ['32396', '12370', '23117'],

 'Vote': ['62143', '61197'],

 'Flower': ['59101', '11947', '22069', '22774'],
 ...
 'Romantic': ['12264', '41166', '23020', '32328', '12263'],

 'Rings': ['11062'],

 'Emesh': ['41190'],

 'Meed': ['41226', '12472', '23199'],

 'Cheer': ['63349', '62263'],

 'Serendipity': ['63317', '62178', '61222'],
 ...
 'Gaudí': ['32167', '22451', '11605', '41110', '11570', '58045', '58046', '11571', '11590', '11879', '11743'],

 'Flor': ['22617', '11701'],

 'Hallow': ['32426'],

 'Away': ['32321', '12279', '23016', '12257'],

 'Libella': ['58006'],

 'Morningstar': ['63313', '61218', '62175'],
 ...
 'Windrose': ['63319', '62179', '61224'],

 'Signature': ['23131'],

 'Saint': ['62285', '61316'],

 'Fire': ['23001', '12245', '32314'],

 'Meadow': ['12433', '32415', '23153'],

 'Tainted': ['32320'],

 'Gerbera': ['32424', '23193', '12467'],

 'Into': ['12230', '22991'],

 'Courage': ['62123', '12253', '23013'],
 ...
 'Change': ['41164', '23081', '41165', '32316', '23014', '12254'],
 ...
 'Solitär': ['63254', '63256', '62119', '61182', '62118', '62120'],

 'Deja Vu': ['32325', '32324', '32326'],

 'Nariphon': ['41196'],

 'Prosper': ['32416', '12434', '23154', '11998', '22807'],
 ...
 'Pure': ['63270', '63210', '63211', '62144', '61109'],

 'Expression': ['11077'],

 'Orient': ['11951', '32270', '22885', '22777'],
 ...
 'Dauntless': ['63331', '61256', '62233'],

 'Miracle': ['23180', '12456'],

 'Mystique': ['63328', '61242', '62213'],
 ...
 'Rabbit': ['41202', '32386', '12329', '23085', '32374'],
 ...
 'Prestige': ['11200', '32057'],

 'Asterlove': ['23159', '12439'],
 ...
 'Fantasia': ['63357', '62271', '61299'],

 'Flow': ['32251', '22845', '12049'],

 'RoyalDrop': ['61199', '62146'],

 'Foursquare': ['63231', '61135'],

 'Fiorellino': ['58048'],

 'Pear': ['61148', '62089'],

 'Flexibility': ['23116', '12390'],

 'Heartbeat': ['12419', '23144'],
 ...
 'Beautify': ['12226', '22985', '32308', '22987'],

 'Extase': ['22731', '11882', '11883'],
 ...
 'chain': ['KS015', 'KS004', 'KS001'],

 'Oblong': ['41216'],

 'Jump': ['23028', '23027'],

 'Freedom': ['12288', '41208', '23098', '12373'],

 'Romana': ['23058'],

 'Links': ['41161', '41163', '41162'],
 ...
 'Music': ['11942', '22771', '22770'],

 'Why': ['63247'],

 'Metsaema': ['12297', '32341'],

 'Timeless': ['11922', '22764'],

 'Lucina': ['12287', '23068'],

 'Soon': ['32186', '11133', '22145'],

 'Distinct': ['63251', '62113', '61176'],
 ...
 'Posh': ['63356', '62268', '61296'],

 'Cara': ['61312'],

 'Azalea': ['63355', '62266', '61294'],

 'DreamCatcher': ['62188', '61251'],

 'Dance': ['31000', '31001'],

 'Genuine': ['63258', '62121', '62122', '61184', '61183'],

 'Wispy': ['12221', '22988', '32304', '32306', '12224'],

 'Soul': ['63332', '62234', '61255', '63539'],
 ...
 'Guardian': ['62212', '63329', '63537'],

 'Florescence': ['12435', '32417', '23155'],

 'Smash': ['23196', '12471'],

 'Maya': ['62254', '63362', '61280'],

 'Precioso': ['32253', '22866'],

 'Grey': ['31003'],

 'Pearly': ['22183', '41051'],

 'Karma': ['62168', '63302', '61282'],

 'Coqui': ['11744', '22647', '11745'],

 'Viridios': ['12305'],

 'Heart': ['S24008', 'S24009', '11616', '12158'],

 'Glory': ['12021', '22819'],

 'Sagrada': ['11575', '11816', '11873'],
 ...
 'Libertá': ['23100', '12375', '32391'],

 'Loving': ['63291'],

 'Water': ['63267', '63524', '61187', '62131'],
 ...
 'Theatrical': ['12403', '32401', '23109'],

 'Rush': ['12265', '23021'],

 'Crescent': ['63314', '62176', '61219'],

 'Cushy': ['12480', '23203'],

 'Target': ['12234', '32312', '22997'],

 'Oceanides': ['23080', '12308', '32363'],

 'Starfish': ['11074', '32033', '22111', '11138', '11137', '11897'],
 ...
 'Gaudi': ['11825', '12012', '12011', '32212', '12010', '11826'],

 'Reason': ['12252', '23012'],

 'Dream': ['62264', '61293'],

 'Delite': ['22759', '11974', '11911'],
 ...
 'Nobly': ['23158', '58050', '12438'],

 'Luminous': ['12449'],

 'Relate': ['63238'],

 'Step': ['63239', '61153', '63527', '63522'],

 'Diana': ['23075'],

 'Right': ['12380', '32410', '23132'],
 ...
 'Lucent': ['11619', '11618', '32162', '22559'],

 'River': ['12248', '23008'],

 'Imperial': ['63250', '63249'],
 ...
 'Duchesse': ['62104', '63246', '61168'],

 'Roma': ['12322'],

 'Mariposa': ['63530', '62167', '61213'],

 'Glint': ['32292', '12188', '22938'],
 ...
 'Oasis': ['63341', '61279', '62251'],

 'Blessing': ['63300'],

 'Anito': ['63298', '61211', '62165'],

 'Breath': ['12042'],

 'Alegra': ['22872', '12126'],

 'Full Heart': ['22091', '11024'],
 ...
 'Stunning': ['32247', '12034'],

 'Show': ['12404', '23142'],

 'Trust': ['41209', '32006', '32005', '23099', '12374', '11273'],

 'Delight': ['32393', '12377', '23102'],

 'Idea': ['12406'],

 'Prayer': ['23019', '12260'],

 'Fame': ['63345', '62225', '32225', '61252'],

 'People': ['23031', '23041', '12271'],
 ...
 'Rainbow': ['22846', '32116', '11395', '12051', '32246'],
 ...
 'Aglow': ['23188', '41224', '12462'],

 'Icy': ['23184'],

 'Newy': ['61144', '62085'],

 'Persephone': ['23056', '61204'],
 ...
 'Windfall': ['63318', '61223', '62224'],

 'Tiana': ['41213'],

 'Fish': ['32334'],

 'Amaterasu': ['32344', '12300'],

 'Call': ['22897', '12120', '32274'],

 'Doubleheart': ['11858'],

 'Cherish': ['61283'],

 'Relax': ['32228', '22750', '11903'],

 'Cybele': ['41173'],

 'Lilith': ['63359', '62273', '61301'],

 'Planet': ['11410'],

 'Promise': ['63344'],

 'Treasure': ['12095', '32250'],

 'Esostre': ['41199'],

 'Ladybug': ['61260', '11182', '62231'],

 'Muse': ['61205'],

 'Titanic': ['12134'],

 'Palmtree': ['63316', '61221', '62223'],
 ...
 'Fine': ['32105', 'KS012R40', 'KS012G55', 'KS012R55', '11353', 'KS012G40', 'KS012RG55', 'KS012RG40'],

 'Luna': ['11765'],

 'Bone': ['11667'],

 'Balance': ['61196', '63269', '62142'],
 ...
 'Wintertime': ['32425', '12469', '23195'],

 'Luxe': ['41227', '23201', '12477'],

 'Minerva': ['63277'],

 'MamaCocha': ['62191'],

 'Liberty': ['63330', '62228', '61257'],
 ...
 'Infinity': ['63029', '61092'],

 'Develop': ['11902', '22749'],

 'Purity': ['63361', '61303', '62275'],

 'Affection': ['23143', '12418'],

 'Number': ['11610'],

 'Vida': ['11815', '32257', '12093', '22870'],

 'Contact': ['63234'],

 'Edellove': ['23157', '12437'],
 ...
 'Moonlight': ['32318', '12255', '23015'],

 'Farfallina': ['11984', '22794'],

 'My': ['12094'],

 'Flowers': ['58001'],

 'Safeguard': ['62204', '61239'],
 ...
 'Sleet': ['23182', '41223', '58068'],

 'Quadrat': ['41181'],

 'Secure': ['12460', '23187'],

 'Beat': ['23036', '11126', '12275'],
 ...
 'Papillon': ['12447', '32421'],

 'Dualism': ['23176', '12452'],

 'Precious': ['11134', '32043'],

 'Barsamin': ['32345', '12301'],

 'Esoteric': ['23179', '12455'],
 ...
 'Company': ['12146', '22907', '32281'],

 'Sun': ['11824', '32221'],

 'Hail': ['58067'],

 'Stellina': ['22791', '11981'],
 ...
 'Tendresse': ['62199', '61235'],

 'Shimmer': ['11899'],

 'Wildflower': ['23191', '12465'],
 ...
 'Heavenly': ['61314', '62283'],

 'Edelbloom': ['12436', '23156'],

 'Unity': ['61304', '62276'],

 'Sublime': ['23067', '12285', '32340'],

 'Animation': ['22732', '11884'],

 'Success': ['62082', '61139'],

 'Freehand': ['23112', '32409', '41218'],

 'Volition': ['23105', '12400'],
 ...
 'Wonder': ['11976', '11975', '41146', '22798'],
 ...
 'Silverpaw': ['62230', '61259'],

 'Dusk': ['41228', '12479', '23202'],
 ...
 'Wintertime Skate': ['12470'],

 'Soar': ['63535', '61233'],

 'Galactic': ['22685', '11791'],
 ...
 'Latitude': ['23103', '12379'],

 'Silvercat': ['62232', '61261'],
